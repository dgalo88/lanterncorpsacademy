...
public class TestDepartmentEmployee extends TestCase {
	...
	private boolean compareDODeep(DepartmentDO departmentDO1,
	...
	private boolean compareDOShallow(DepartmentDO departmentDO1,
			DepartmentDO departmentDO2) {
		boolean ret = true;
	...
	private boolean compareDOShallow(EmployeeDO employeeDO1,
			EmployeeDO employeeDO2) {
		boolean ret = true;
	...
	public void testRefOnInsert() throws Exception {
		...
		employeeDO1.getDepartmentRef().setRefValue(departmentDO1); // ---------->
																	// LINK
		...
		employeeDO2.getDepartmentRef().setRefValue(departmentDO1); // ---------->
																	// LINK
		...
		employeeDO3.getDepartmentRef().setRefValue(departmentDO2); // ---------->
																	// LINK
		...
		employeeDO4.getDepartmentRef().setRefValue(departmentDO2); // ---------->
																	// LINK
	...
	public void testRefOnUpdate() throws Exception {
		...
		employeeDO2.getDepartmentRef().setRefValue(departmentDO2); // ---------->
																	// LINK
		...
		employeeDOc.getDepartmentRef().setRefValue(departmentDOa); // ---------->
																	// LINK
		...
		employeeDOd.getDepartmentRef().setRefValue(departmentDOb); // ---------->
																	// LINK
		// If I don't add I can't compare below
	...
	public void testRefCrash() throws Exception {
		...
		employeeDO.getDepartmentRef().setRefValue(departmentDO); // ---------->
																	// LINK
