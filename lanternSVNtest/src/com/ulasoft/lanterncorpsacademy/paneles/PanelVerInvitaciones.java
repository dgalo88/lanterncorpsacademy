...
public class PanelVerInvitaciones extends Panel {
	...
	public PanelVerInvitaciones() {
		...
		btnRechazar.setStyle(Estilo.getDefaultStyleColor(app.getAtributos()));
		...
		btnRechazarTodos.setStyle(Estilo.getDefaultStyleColor(app.getAtributos()));
		...
		btnAceptar.setStyle(Estilo.getDefaultStyleColor(app.getAtributos()));
