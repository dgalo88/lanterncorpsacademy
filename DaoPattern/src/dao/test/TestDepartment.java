...
public class TestDepartment extends TestCase {
  ...
  private boolean compareDO(DepartmentDO departmentDO1, DepartmentDO departmentDO2) {
    boolean ret = true;
  ...
  public void testListAll() throws Exception {
    ...
    assertTrue(compareDO(departmentDO1, (DepartmentDO) departmentList.get(0)));
    assertTrue(compareDO(departmentDO2, (DepartmentDO) departmentList.get(1)));
  ...
  public void testListAllLimOff() throws Exception {
    ...
    assertEquals(1, departmentList.size());
    assertTrue(compareDO(departmentDO2, (DepartmentDO) departmentList.get(0)));
