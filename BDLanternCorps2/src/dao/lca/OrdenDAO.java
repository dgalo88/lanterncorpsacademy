...
public class OrdenDAO extends BaseDAO {
	...
	public void createTable() throws SQLException {
		...
		strbuf.append("INT,    ");
		strbuf.append(OrdenDO.MISION);
		strbuf.append("INT  REFERENCES    ");
		strbuf.append(m.getTableName());
		strbuf.append(" ");
		strbuf.append(MisionDO.ID);
		strbuf.append(", ");
		strbuf.append(OrdenDO.OBJETIVO);
		strbuf.append("INT  REFERENCES    ");
	...
	public void insert(DataObject dataObject) throws SQLException {
		...
		OrdenDO departmentDO = (OrdenDO) dataObject;
		...
		strbuf.append(", ");
		strbuf.append(departmentDO.getPrioridad());
		strbuf.append(", ");
		strbuf.append(departmentDO.getMisionRef().getRefValue().getId());
		strbuf.append(", ");
		strbuf.append(departmentDO.getObjetivoRef().getRefValue().getId());
		strbuf.append(")");
	...
	private OrdenDO resultSetToDO(ResultSet rs) throws SQLException {
		...
		refm.setRefIdent(rs.getInt(OrdenDO.MISION));
		ret.setMisionRef(refm);

		Reference<ObjetivoDO> refo = new Reference<ObjetivoDO>();
		refo.setRefIdent(rs.getInt(OrdenDO.OBJETIVO));
