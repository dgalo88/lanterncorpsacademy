...
public class test1 {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			cdo[ROJO].setNombre_de_cuerpo_linterna("ROJO");
			cdo[VERDE].setNombre_de_cuerpo_linterna("VERDE");
			cdo[AZUL].setNombre_de_cuerpo_linterna("AZUL");
			cdo[AMARILLO].setNombre_de_cuerpo_linterna("AMARILLO");
			...
			for (int i = 0; i < 7; i++) {
				...
				mdo[i].setPuntos_de_entrenamiento_ganados(nm + nm);
				mdo[i].setNivel_necesario(i + 1);
				mdo[i].setExperiencia_ganada(i * nm + 1);
