...
public class ClaseLinternaDAO extends BaseDAO implements IClaseLinternaDAO {
	...
	public void loadGrupoList(IClaseLinternaDO claseLinternaDO) throws Exception {
		...
		claseLinternaDO.setGrupoList( //
				grupoDAO.listByClaseLinternaId(claseLinternaDO.getId()));
	}
	...
	public void loadPersonajeList(IClaseLinternaDO claseLinternaDO) throws Exception {
		...
		claseLinternaDO.setPersonajeList( //
				personajeDAO.listByClaseLinternaId(claseLinternaDO.getId()));
	}
	...
	public void loadHabilidadClaseLinternaList(IClaseLinternaDO claseLinternaDO) throws Exception {
		...
		HabilidadClaseLinternaDAO habilidadClaseLinternaDAO = //
			(HabilidadClaseLinternaDAO) FactoryDAO.getDAO( //
				HabilidadClaseLinternaDAO.class, connectionBean);

		claseLinternaDO.setHabilidadClaseLinternaList( //
				habilidadClaseLinternaDAO.listByClaseId(claseLinternaDO.getId()));
	}
	...
	public void loadMisionClaseLinternaList(IClaseLinternaDO claseLinternaDO) throws Exception {
		...
		MisionClaseLinternaDAO misionClaseLinternaDAO = //
			(MisionClaseLinternaDAO) FactoryDAO.getDAO( //
				MisionClaseLinternaDAO.class, connectionBean);

		claseLinternaDO.setMisionClaseLinternaList( //
				misionClaseLinternaDAO.listByClaseLinternaId(claseLinternaDO.getId()));
	}
