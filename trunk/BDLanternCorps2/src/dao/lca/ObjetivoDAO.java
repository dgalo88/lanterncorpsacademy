...
//    PlanetaDAO p = new PlanetaDAO();
    ...
    strbuf.append(ObjetivoDO.NUMERO);
    strbuf.append(" INT,     ");
    strbuf.append(ObjetivoDO.PLANETA);
...
//	strbuf.append(p.getTableName());
  ...
  public void insert(DataObject dataObject) throws SQLException {
    ...
    strbuf.append(", ");
    strbuf.append(objetivoDO.getNumero_de_npc());
    strbuf.append(", ");
  ...
  private ObjetivoDO resultSetToDO(ResultSet rs) throws SQLException {
    ...
    ret.setNumero_de_npc(rs.getInt(ObjetivoDO.NUMERO));
    
    Reference<PlanetaDO> p = new Reference<PlanetaDO>();
    p.setRefIdent(rs.getInt(ObjetivoDO.NUMERO));    
    ret.setPlanetaRef(p);
