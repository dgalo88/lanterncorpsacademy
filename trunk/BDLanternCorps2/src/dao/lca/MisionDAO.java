...
public class MisionDAO extends BaseDAO {
  ...
  public void createTable() throws SQLException {
    ...
    strbuf.append(" VARCHAR(100),     ");
    strbuf.append(MisionDO.EXPERIENCIA);
    strbuf.append(" INT,     ");
    strbuf.append(MisionDO.PUNTOS);
    strbuf.append(" INT,     ");
    strbuf.append(MisionDO.NIVEL);
    strbuf.append(" INT     ");
    strbuf.append(")");
  ...
  private MisionDO resultSetToDO(ResultSet rs) throws SQLException {
    ...
    ret.setExperiencia_ganada(rs.getInt(MisionDO.EXPERIENCIA));
    ret.setPuntos_de_entrenamiento_ganados(rs.getInt(MisionDO.PUNTOS));
    ret.setNivel_necesario(rs.getInt(MisionDO.NIVEL));
