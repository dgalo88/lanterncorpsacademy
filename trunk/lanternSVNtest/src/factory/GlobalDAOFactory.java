...
public class GlobalDAOFactory {
	...
	private static InterfaceDAO createDAOLCA(Class<? extends InterfaceDAO> clazz, ConnectionBean connectionBean)
			throws Exception {
		...
		if (clazz.equals(IUsuarioDAO.class)) {
			...
			return FactoryDAO.getDAO(dao.lca.PersonajeDAO.class, connectionBean);
			...
			return FactoryDAO.getDAO(dao.lca.NivelHabilidadDAO.class, connectionBean);
			
		}else if (clazz.equals(IMisionPersonajeDAO.class)) {
			
			return FactoryDAO.getDAO(dao.lca.MisionPersonajeDAO.class, connectionBean);
			...
			return FactoryDAO.getDAO(dao.lca.MisionClaseLinternaDAO.class, connectionBean);
			
		}else if (clazz.equals(IHabilidadDAO.class)) {
			
			return FactoryDAO.getDAO(dao.lca.HabilidadDAO.class, connectionBean);
			
		}else if (clazz.equals(IHabilidadClaseLinternaDAO.class)) {
			
			return FactoryDAO.getDAO(dao.lca.HabilidadClaseLinternaDAO.class, connectionBean);
			
		}else if (clazz.equals(IHabilidadActivaDAO.class)) {
			
			return FactoryDAO.getDAO(dao.lca.HabilidadActivaDAO.class, connectionBean);
			...
			return FactoryDAO.getDAO(dao.lca.ClaseLinternaDAO.class, connectionBean);
	...
	private static InterfaceDAO createDAOLANTERN(Class<? extends InterfaceDAO> clazz, ConnectionBean connectionBean)
			throws Exception {
