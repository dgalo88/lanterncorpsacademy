...
public class GlobalDAOFactory {
	...
	private static InterfaceDAO createDAOLANTERN( //
		...
		} else if (clazz.equals(IOfertaDAO.class)) {

			return FactoryDAO.getDAO(dao.lantern.OfertaDAO.class,
					connectionBean);

		} else if (clazz.equals(IOfertaPersonajeDAO.class)) {

			return FactoryDAO.getDAO(dao.lantern.OfertaPersonajeDAO.class,
					connectionBean);
