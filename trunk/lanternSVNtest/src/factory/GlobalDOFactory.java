...
public class GlobalDOFactory {
	...
	private static DataObject createDOLANTERN(Class<? extends DataObject> clazz) {
		...
		} else if (clazz.equals(IOfertaDO.class)) {

			return new dao.lantern.OfertaDO();

		} else if (clazz.equals(IOfertaPersonajeDO.class)) {

			return new dao.lantern.OfertaPersonajeDO();
