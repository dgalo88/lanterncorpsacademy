...
public class YellowStyles {
	  ...
	  static {
		  ...
		  style.set(Button.PROPERTY_FOCUSED_BORDER, new Border(1, Color.YELLOW, Border.STYLE_SOLID));
	  ...
	  public static final Style STYLE2_AMARILLO;
	  ...
	  static {
		  ...
		  style.set(Button.PROPERTY_ROLLOVER_BACKGROUND, new Color(245, 255, 107));
		  style.set(Button.PROPERTY_ROLLOVER_BORDER, new Border(1, Color.BLACK, Border.STYLE_SOLID));
		  
		  STYLE2_AMARILLO = style;
	  }
}
